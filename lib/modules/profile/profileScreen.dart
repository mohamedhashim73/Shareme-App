                ...
                appBar: AppBar(
                  ...
                  actions: [
                    Padding(
                      ...
                      child: Row(
                        children: [
                          InkWell(onTap: (){},child: const Icon(Icons.add_box_outlined),),
                    ...
                    child: Column(
                      ...
                      [
                        ...
                        GridView.builder(
                            ...
                            shrinkWrap: true,
                            itemCount: 9,
                            gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 3,childAspectRatio:0.9,mainAxisSpacing: 2,crossAxisSpacing: 2),
                            itemBuilder: (context,i){
    ...
    return List.generate(3, (index){
      return Container(
        ...
        child: InkWell(
          ...
          child: Column(
            children: [
              CircleAvatar(minRadius:30,child: customCacheNetworkImage(),),
              const SizedBox(height: 10,),
